...
golden_leaf %>% ggplot(aes(y=county_name, x=grant_award)) + xlim(0, 300000)+ labs(y = "County", x = "Grant Award in Thousands", title = "Grant Awarded to Each County") + theme_classic() + geom_col()
```
```
```{r}
